...
{/* eligible? */}
                <section>
                    ...
                    <img id="eligible_" src={Eligible}/>
                </section>

{/* our culture */}
                <section className="the_culture">
                    <div>
                        <img id="culture_" src={Culture}/> <img id="play" src={Play}/>
                    </div>
                    <div>
                        <h2>Our Culture</h2>
                        <p>
...
{/*Anti classroom learning */}
                <section className="class_learn">
                    <div>
                        <img id="col2" src={Collage2}/>
                    </div>
                    <div>
